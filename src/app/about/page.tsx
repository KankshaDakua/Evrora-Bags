    ...
    return (
        <div className="bg-background text-foreground">
            ...
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
                ...
                >
                    <h1 className="text-4xl sm:text-5xl font-bold font-serif text-primary">About WholeSale Wala</h1>
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center mb-24">
                    ...
                    >
                        ...
                        <p className="text-muted-foreground">
                            WholeSale Wala was born from a passion for timeless design and impeccable craftsmanship. We set out to create handbags that are not only beautiful but also functional and enduring. Each piece in our collection is a testament to our commitment to quality, sustainability, and the art of modern elegance.
                        </p>
                        <p className="text-muted-foreground">
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8 text-center">
                    <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}>
                        <Card>
                            <CardHeader>
                     ...
                     <motion.div initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.6, ease: "easeOut", delay: 0.3 }}>
                        <Card>
                            <CardHeader>
                                <div className="mx-auto bg-secondary rounded-full p-4 w-fit">
