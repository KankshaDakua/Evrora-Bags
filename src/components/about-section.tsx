        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
                ...
                <p className="text-muted-foreground mb-8">
                    Our philosophy is simple: create beautiful, functional pieces that you'll cherish for a lifetime. Evrora Bags are designed to be more than just an accessory—they are a statement of style and a testament to enduring quality.
                </p>
                <Button asChild>
